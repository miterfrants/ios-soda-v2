...
-(void)scrollViewDidScroll:(UIScrollView*)scrollView{
    ...
    if(scrollView.contentOffset.y-memoryY<40 && scrollView.contentOffset.y-memoryY>0){
        ...
        [self setFrame:CGRectMake(self.frame.origin.x, 40-scrollView.contentOffset.y+memoryY, self.frame.size.width, self.gv.screenH-80-40+scrollView.contentOffset.y-memoryY)];
        ...
        [self setFrame:CGRectMake(self.frame.origin.x, 40, self.frame.size.width, self.gv.screenH-80-40)];
        ...
        [self setFrame:CGRectMake(self.frame.origin.x, 0, self.frame.size.width, self.gv.screenH-80)];
    }
